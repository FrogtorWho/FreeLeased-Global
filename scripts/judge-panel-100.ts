...
const SNAPSHOT: Claim[] = [
  {
    ...
    fetched: "2026-08-12",
    conviction: "verified",
    axisScores: { legality: 10, feasibility: 9 },
  },
  {
    ...
    fetched: "2026-08-12",
    conviction: "verified",
    axisScores: { legality: 10, evidence: 10 },
  },
  {
    ...
    fetched: "2026-08-12",
    conviction: "verified",
    axisScores: { legality: 10, equity: 10 },
  },
  {
    ...
    fetched: "2026-08-12",
    conviction: "verified",
    axisScores: { evidence: 10, feasibility: 9 },
  },
  {
    ...
    fetched: "2026-08-12",
    conviction: "verified",
    axisScores: { innovation: 10, feasibility: 10 },
  },
  {
    ...
    fetched: "2026-08-12",
    conviction: "verified",
    axisScores: { feasibility: 10, evidence: 10 },
  },
  {
    ...
    fetched: "2026-08-12",
    conviction: "verified",
    axisScores: { evidence: 10, feasibility: 10 },
  },
  {
    ...
    fetched: "2026-08-12",
    conviction: "verified",
    axisScores: { evidence: 10, clarity: 10 },
  },
  {
    ...
    fetched: "2026-08-12",
    conviction: "verified",
    axisScores: { feasibility: 10, equity: 10 },
  },
  {
  ...
  },
  {
    ...
    fetched: "2026-08-12",
    conviction: "verified",
    axisScores: { legality: 10, impact: 9 },
  },
  {
    ...
    fetched: "2026-08-12",
    conviction: "verified",
    axisScores: { impact: 10, equity: 10 },
  },
  {
    ...
    fetched: "2026-08-12",
    conviction: "verified",
    axisScores: { innovation: 10, equity: 10 },
  },
];
...
function scoreJudge(judge: Judge): { axis: Axis; score: number; weight: number; evidence: string }[] {
  ...
  for (const axis of judge.axes as Axis[]) {
    // Take the max axisScore across the snapshot — judges score based on
    // the strongest evidence the build provides for their assigned axis.
    let best = 0;
    let bestEvidence = "";
    ...
    out.push({
      axis,
      score: Math.min(10, Number((best + tilt).toFixed(2))),
      weight: judge.weight,
