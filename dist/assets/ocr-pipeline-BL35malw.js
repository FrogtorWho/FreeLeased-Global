const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-DdwZXDk9.js","./index-LOxSCVEp.js","./index-D5lHmIok.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './index-LOxSCVEp.js';
...
async function getWorker(lang = "eng") {
  ...
  const Tesseract = await __vitePreload(() => import('./index-DdwZXDk9.js').then(n => n.i),true              ?__vite__mapDeps([0,1,2]):void 0,import.meta.url);
