const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-De_eujtS.js","./index-BlceVJxD.js","./index-BEgg8jNX.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './index-BlceVJxD.js';
...
async function getWorker(lang = "eng") {
  ...
  const Tesseract = await __vitePreload(() => import('./index-De_eujtS.js').then(n => n.i),true              ?__vite__mapDeps([0,1,2]):void 0,import.meta.url);
