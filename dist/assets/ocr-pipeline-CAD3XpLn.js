const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-CCGqbzfB.js","./index-BG8VGcYy.js","./index-v-UxnzKO.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './index-BG8VGcYy.js';
...
async function getWorker(lang = "eng") {
  ...
  const Tesseract = await __vitePreload(() => import('./index-CCGqbzfB.js').then(n => n.i),true              ?__vite__mapDeps([0,1,2]):void 0,import.meta.url);
