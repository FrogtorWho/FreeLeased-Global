const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-BYlm3g_J.js","./index-DISCsu-r.js","./index-BEgg8jNX.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './index-DISCsu-r.js';
...
async function getWorker(lang = "eng") {
  ...
  const Tesseract = await __vitePreload(() => import('./index-BYlm3g_J.js').then(n => n.i),true              ?__vite__mapDeps([0,1,2]):void 0,import.meta.url);
