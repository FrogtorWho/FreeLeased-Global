const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-s-ocJn0-.js","./index-DHVCvIf4.js","./index-D5lHmIok.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './index-DHVCvIf4.js';
...
async function getWorker(lang = "eng") {
  ...
  const Tesseract = await __vitePreload(() => import('./index-s-ocJn0-.js').then(n => n.i),true              ?__vite__mapDeps([0,1,2]):void 0,import.meta.url);
