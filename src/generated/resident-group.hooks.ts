...
/**
 * Hooks for ResidentGroup routes
 */
export interface ResidentGroupHooks {
  /**
...
/**
 * Default ResidentGroup hooks (customize as needed)
 */
export const residentGroupHooks: ResidentGroupHooks = {
