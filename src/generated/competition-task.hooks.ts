...
/**
 * Hooks for CompetitionTask routes
 */
export interface CompetitionTaskHooks {
  /**
...
/**
 * Default CompetitionTask hooks (customize as needed)
 */
export const competitionTaskHooks: CompetitionTaskHooks = {
