...
/**
 * Hooks for StatuteRecord routes
 */
export interface StatuteRecordHooks {
  /**
...
/**
 * Default StatuteRecord hooks (customize as needed)
 */
export const statuteRecordHooks: StatuteRecordHooks = {
