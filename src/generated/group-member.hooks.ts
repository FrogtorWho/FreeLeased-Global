...
/**
 * Hooks for GroupMember routes
 */
export interface GroupMemberHooks {
  /**
...
/**
 * Default GroupMember hooks (customize as needed)
 */
export const groupMemberHooks: GroupMemberHooks = {
