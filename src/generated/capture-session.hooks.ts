...
/**
 * Hooks for CaptureSession routes
 */
export interface CaptureSessionHooks {
  /**
...
/**
 * Default CaptureSession hooks (customize as needed)
 */
export const captureSessionHooks: CaptureSessionHooks = {
