...
/**
 * Hooks for GroupBallot routes
 */
export interface GroupBallotHooks {
  /**
...
/**
 * Default GroupBallot hooks (customize as needed)
 */
export const groupBallotHooks: GroupBallotHooks = {
