...
/**
 * Hooks for ResearchTask routes
 */
export interface ResearchTaskHooks {
  /**
...
/**
 * Default ResearchTask hooks (customize as needed)
 */
export const researchTaskHooks: ResearchTaskHooks = {
