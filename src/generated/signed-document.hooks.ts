...
/**
 * Hooks for SignedDocument routes
 */
export interface SignedDocumentHooks {
  /**
...
/**
 * Default SignedDocument hooks (customize as needed)
 */
export const signedDocumentHooks: SignedDocumentHooks = {
