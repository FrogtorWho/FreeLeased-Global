...
/**
 * Hooks for DocumentSignature routes
 */
export interface DocumentSignatureHooks {
  /**
...
/**
 * Default DocumentSignature hooks (customize as needed)
 */
export const documentSignatureHooks: DocumentSignatureHooks = {
