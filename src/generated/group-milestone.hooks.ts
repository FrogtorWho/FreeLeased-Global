...
/**
 * Hooks for GroupMilestone routes
 */
export interface GroupMilestoneHooks {
  /**
...
/**
 * Default GroupMilestone hooks (customize as needed)
 */
export const groupMilestoneHooks: GroupMilestoneHooks = {
