...
/**
 * Hooks for ContentDraft routes
 */
export interface ContentDraftHooks {
  /**
...
/**
 * Default ContentDraft hooks (customize as needed)
 */
export const contentDraftHooks: ContentDraftHooks = {
