...
/**
 * Hooks for GroupMessage routes
 */
export interface GroupMessageHooks {
  /**
...
/**
 * Default GroupMessage hooks (customize as needed)
 */
export const groupMessageHooks: GroupMessageHooks = {
