...
/**
 * Hooks for GroupDocument routes
 */
export interface GroupDocumentHooks {
  /**
...
/**
 * Default GroupDocument hooks (customize as needed)
 */
export const groupDocumentHooks: GroupDocumentHooks = {
