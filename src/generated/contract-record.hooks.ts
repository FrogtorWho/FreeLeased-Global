...
/**
 * Hooks for ContractRecord routes
 */
export interface ContractRecordHooks {
  /**
...
/**
 * Default ContractRecord hooks (customize as needed)
 */
export const contractRecordHooks: ContractRecordHooks = {
