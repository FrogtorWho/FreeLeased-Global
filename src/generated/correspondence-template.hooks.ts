...
/**
 * Hooks for CorrespondenceTemplate routes
 */
export interface CorrespondenceTemplateHooks {
  /**
...
/**
 * Default CorrespondenceTemplate hooks (customize as needed)
 */
export const correspondenceTemplateHooks: CorrespondenceTemplateHooks = {
