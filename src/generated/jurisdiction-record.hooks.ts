...
/**
 * Hooks for JurisdictionRecord routes
 */
export interface JurisdictionRecordHooks {
  /**
...
/**
 * Default JurisdictionRecord hooks (customize as needed)
 */
export const jurisdictionRecordHooks: JurisdictionRecordHooks = {
