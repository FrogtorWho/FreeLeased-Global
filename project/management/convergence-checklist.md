...
|---|---|---|---|---|---|
| 1 | Submission pack complete (all `project/submission-pack/*.md` coherent + cross-linked) | **DONE** | All 8 files in `project/submission-pack/` have HTML-comment frontmatter (purpose, audience, status, last-updated, owner, cross-links). Cross-link graph: submission-pack ↔ project/strategy ↔ docs ↔ scripts | none | agent |
